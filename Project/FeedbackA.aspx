<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeedbackA.aspx.cs" Inherits="Project.FeedbackA" %>
...
<body>
    <form runat="server">
        ...
        <section class="home-section" style="margin-right:500px;">
            <div class="text">List of Feedback from Customer</div>
            
            <!-- Add GridView to display feedback data -->
            <div class="table-container">
                <asp:GridView ID="GridViewFeedback" runat="server" CssClass="table" AutoGenerateColumns="False" GridLines="Both">
                    <Columns>
