...
<section class="home-section" style="margin-right:500px;">
    <div class="text">Book Record (Use ISBN) </div>
    ...
    <div class="form-table-container">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <asp:TextBox ID="txtISBN" runat="server" CssClass="form-control" Columns="2" Rows="4" Text="ISBN"></asp:TextBox>
            </div>
            <div class="form-group">
...
<div class="button-container text-left mt-3" style="margin-left: 30px;">
    <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="btn btn-secondary mx-2" OnClick="btnUpdate_Click" />
    <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="btn btn-danger mx-2" OnClick="btnDelete_Click" />
    <asp:Button ID="btnGet" runat="server" Text="Search" CssClass="btn btn-info mx-2" OnClick="btnGet_Click" />
    <asp:Button ID="btnWant" runat="server" Text="Get" CssClass="btn btn-warning mx-2" OnClick="btnWant_Click" />
</div>
    </div>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="table">
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Publication Year">
            <ItemTemplate>
                <div style="text-align: center; width: 50px;"><%# Eval("Year") %></div>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:BoundField DataField="ISBN" HeaderText="ISBN" />
        <asp:TemplateField HeaderText="Book Quantity">
            <ItemTemplate>
                <div style="text-align: center; width: 50px;"><%# Eval("Quantity") %></div>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField>
            <ItemTemplate>
