...
<div class="container mt-5" style="margin-right: 50px;">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <asp:TextBox runat="server" ID="txtId" CssClass="form-control" placeholder="Enter ID"></asp:TextBox>
            </div>
            <div class="form-group">
            ...
            <div class="text-center">
                ...
                <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btn btn-secondary ml-2" OnClick="ButtonCancel_Click" />
            </div>
